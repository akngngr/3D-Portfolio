...
const projects = [
  ...
  },
  {
    name: "Crypto Tracker",
    description:
      "Real-time cryptocurrency tracker that pulls live prices and market trends from a public API — searchable coin list, detailed stats, and responsive charts wired through a fetch-based data layer.",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
